...
public class StartUpIdea implements Comparable<StartUpIdea> {
     ...
     */
    public StartUpIdea(String usp, String sell, String cost, int customerNeed,
                        int knownPeopleWithProblem, int targetMarketSize) {
        this.usp = usp;
        this.sell = sell;
        this.cost = cost;
    ...
    public StartUpIdea(String problem, String targetCustomer,
                       ...
                       int targetMarketSize, int seed, String competitors) {
    ...
    public String toString2() {
        String str = "";
        str += "Unique selling point: " + usp + "\n";
        str += "How to sell product: " + sell + "\n";
        str += "How to price product: " + cost + "\n";
        return str;
    }
    /**
     * Optional for student to change
